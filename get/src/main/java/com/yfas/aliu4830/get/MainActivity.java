...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        content = (EditText) findViewById(R.id.input);    //获取输入文本内容的EditText组件
        final TextView resultTV = (TextView) findViewById(R.id.output);    //获取显示结果的TextView组件
        Button button = (Button) findViewById(R.id.deploy);    //获取“发表”按钮组件
    ...
    public void send() {  //创建send()方法，用于建立一个HTTP连接，并将输入的内容发送到Web服务器上，再读取服务器的处理结果
        String target = "";
        target = "http://192.168.1.31:8080/get/get.jsp?content="
